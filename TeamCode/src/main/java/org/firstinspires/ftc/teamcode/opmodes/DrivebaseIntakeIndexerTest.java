...
public class DrivebaseIntakeIndexerTest extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addLine("gp1: left stick drive, right stick X turn, A toggle centric, Options zero heading.");
        telemetry.addLine("gp2: RB/LB/A intake in/out/idle, dpad up/down/B indexer feed/reverse/idle.");
        telemetry.update();
    }
